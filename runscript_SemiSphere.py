...
#gen.runOneFPS(PSS)
#gen.wholeRun(PSS)
#ss.DataRunSemiSphere(path) 

#DRSS = ss.DataRunSemiSphere(path)
#DRSS._getFinalPosition(forPub=True, savePath='M:\\EdgarHaener\\Capsules\\PlotScripts\\Semi-Sphere\\')
#DRSS._speedVsXpos(savePath='M:\\EdgarHaener\\Capsules\\PlotScripts\\Semi-Sphere\\')
#
#ana.wholeRun(ss.runFunction, directory)
#ss.runFunction(path)
#FPS=10
#ana.runOneFPS(ss.runFunction, directory, FPS)
#
#print(ana._pathExperimentRsltFile(path, isDirectory=False))
#print(ana._pathExperimentRsltFile(directory, isDirectory=True))
#
#RCSS = ss.ResultsClassSemiSphere(directory);
##RCSS.plotRslts()
#RCSS._findAverages()
#RCSS._plotAbsFinalVsInitialOffset(forPub=True)
#RCSS._plotQVsMeanHeightEndSS()
#RCSS._plotNormedFinalVsInitialOffset()
#RCSS._plotQVsInitialOffset()
#RCSS._plotAbsFinalVsInitialOffset(True)
#RCSS._plotAllFinalVsInitialOffset()
#RCSS.plotRslts_small()
#RCSS._plotQVsFinalOffset(fit=True, mode='exp')
#RCSS._plotQVsAngle(fit=True, mode='exp')
#RCSS._plotQVsVelocity()
#print(RCSS.batchName)
